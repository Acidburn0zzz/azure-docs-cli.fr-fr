...
La version actuelle de l’interface CLI est __2.0.49__. Pour plus d’informations sur la version la plus récente, consultez les [Notes de publication](release-notes-azure-cli.md).
