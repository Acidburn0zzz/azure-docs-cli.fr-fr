...
La version actuelle de l’interface de ligne de commande est __2.0.52__. Pour plus d’informations sur la version la plus récente, consultez les [Notes de publication](release-notes-azure-cli.md).
