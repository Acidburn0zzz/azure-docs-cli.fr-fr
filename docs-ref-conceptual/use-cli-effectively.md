...
Par souci de clarté, les scripts Bash sont utilisés inline. Les exemples PowerScript ou de commandes Windows sont listés dans l’annexe, que vous pouvez utiliser pour générer des exemples similaires.
