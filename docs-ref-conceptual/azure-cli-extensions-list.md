...
| [azure-cli-iot-ext](https://github.com/azure/azure-iot-cli-extension) | 0.4.4 | Fourniture de la couche de commandes du plan de données pour Azure IoT Hub, IoT Edge et le service de provisionnement d’appareils IoT |  |
| [botservice](https://github.com/Azure/azure-cli-extensions) | 0.0.1 | Prise en charge des fonctionnalités préliminaires de Azure Bot Service 2017-12-01 | OUI |
| [dns](https://github.com/Azure/azure-cli-extensions) | 0.0.2 | Une extension Azure CLI pour les zones DNS |  |
| [eventgrid](https://github.com/Azure/azure-cli-extensions) | 0.2.0 | Prise en charge des fonctionnalités d’Azure EventGrid 2018-05-01-préversion | OUI |
...
| [storage-preview](https://github.com/Azure/azure-cli-extensions) | 0.1.0 | Fournit un aperçu des fonctionnalités de stockage à venir. | OUI |
