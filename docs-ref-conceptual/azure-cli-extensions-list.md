...
| [azure-cli-ml](https://docs.microsoft.com/python/api/overview/azure/ml/?view=azure-ml-py) | 1.15.0 | Module de commande AzureML des outils en ligne de commande Microsoft Azure |  |
...
| [azure-iot](https://github.com/azure/azure-iot-cli-extension) | 0.10.3 | Extension Azure IoT pour Azure CLI. |  |
...
| [connectedk8s](https://github.com/Azure/azure-cli-extensions) | 0.2.6 | Extension Microsoft Azure Command-Line Tools Connectedk8s | Oui |
...
| [storage-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/storage-preview) | 0.3.0 | Fournit un aperçu des fonctionnalités de stockage à venir. | Oui |
