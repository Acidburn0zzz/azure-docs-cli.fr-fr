...
| [préversion ASK](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.2 | Fournit une préversion des fonctionnalités AKS à venir | OUI |
...
| [azure-cli-ml](https://docs.microsoft.com/en-us/azure/machine-learning/service/) | 1.0.41.1 | Module de commande AzureML des outils en ligne de commande Microsoft Azure |  |
